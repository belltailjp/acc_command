...
const char *gengetopt_args_info_purpose = "入力された数値列の各種統計量を計算する";

const char *gengetopt_args_info_usage = "Usage: acc [OPTIONS]...";
...
cmdline_parser_dump(FILE *outfile, struct gengetopt_args_info *args_info)
{
  ...
  if (args_info->mean_given)
    write_into_file(outfile, "mean", 0, 0 );
  if (args_info->var_given)
...
static void
reset_group_type(struct gengetopt_args_info *args_info)
{
  if (! args_info->type_group_counter)
    return;
...
cmdline_parser_required2 (struct gengetopt_args_info *args_info, const char *prog_name, const char *additional_error)
{
  ...
  if (args_info->type_group_counter == 0)
    {
      fprintf (stderr, "%s: %d options of group type were given. One is required%s.\n", prog_name, args_info->type_group_counter, (additional_error ? additional_error : ""));
      error = 1;
    }
                        ...
                        struct cmdline_parser_params *params, const char *additional_error)
{
  ...
  while (1)
    {
      ...
      switch (c)
        ...
        case 0:	/* Long option with no short option */
          /* 総和.  */
          if (strcmp (long_options[option_index].name, "sum") == 0)
          {
            ...
            if (update_arg( 0 , 
                 0 , &(args_info->sum_given),
                &(local_args_info.sum_given), optarg, 0, 0, ARG_NO,
                check_ambiguity, override, 0, 0,
                "sum", '-',
                additional_error))
              goto failure;
          ...
          else if (strcmp (long_options[option_index].name, "min") == 0)
          {
            ...
            if (update_arg( 0 , 
                 0 , &(args_info->min_given),
                &(local_args_info.min_given), optarg, 0, 0, ARG_NO,
                check_ambiguity, override, 0, 0,
                "min", '-',
                additional_error))
              goto failure;
          ...
          else if (strcmp (long_options[option_index].name, "max") == 0)
          {
            ...
            if (update_arg( 0 , 
                 0 , &(args_info->max_given),
                &(local_args_info.max_given), optarg, 0, 0, ARG_NO,
                check_ambiguity, override, 0, 0,
                "max", '-',
                additional_error))
              goto failure;
          ...
          /* 平均値.  */
          else if (strcmp (long_options[option_index].name, "mean") == 0)
          {
            ...
            if (update_arg( 0 , 
                 0 , &(args_info->mean_given),
                &(local_args_info.mean_given), optarg, 0, 0, ARG_NO,
                check_ambiguity, override, 0, 0,
                "mean", '-',
                additional_error))
              goto failure;
          ...
          /* 分散.  */
          else if (strcmp (long_options[option_index].name, "var") == 0)
          {
            ...
            if (update_arg( 0 , 
                 0 , &(args_info->var_given),
                &(local_args_info.var_given), optarg, 0, 0, ARG_NO,
                check_ambiguity, override, 0, 0,
                "var", '-',
                additional_error))
              goto failure;
          ...
          /* 中央値.  */
          else if (strcmp (long_options[option_index].name, "med") == 0)
          {
  ...
  if (args_info->type_group_counter > 1)
    {
      fprintf (stderr, "%s: %d options of group type were given. One is required%s.\n", argv[0], args_info->type_group_counter, (additional_error ? additional_error : ""));
      error = 1;
    }
